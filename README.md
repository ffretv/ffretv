...
Dynamic section at offset 0x39b6c8 contains 74 entries:
  Tag        Type                         Name/Value
 0x0000000000000001 (NEEDED)             Shared library: [libmythswscale.so.4]
 0x0000000000000001 (NEEDED)             Shared library: [libmythavformat.so.57]
 0x0000000000000001 (NEEDED)             Shared library: [libmythswresample.so.2]
 0x0000000000000001 (NEEDED)             Shared library: [libmythavutil.so.55]
 0x0000000000000001 (NEEDED)             Shared library: [libmythavcodec.so.57]
 0x0000000000000001 (NEEDED)             Shared library: [libmythpostproc.so.54]
 0x0000000000000001 (NEEDED)             Shared library: [libmythavfilter.so.6]
 0x0000000000000001 (NEEDED)             Shared library: [libmythtv-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythupnp-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythbase-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythui-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmyth-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythmetadata-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythservicecontracts-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythprotoserver-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythfreemheg-29.so.29]
 0x0000000000000001 (NEEDED)             Shared library: [libmythhdhomerun-29.so.29]
 ...
 0x000000000000000c (INIT)               0x464f28
 0x000000000000000d (FINI)               0x6d03c4
 0x0000000000000019 (INIT_ARRAY)         0x98cd88
 0x000000000000001b (INIT_ARRAYSZ)       200 (bytes)
 0x000000000000001a (FINI_ARRAY)         0x98ce50
 0x000000000000001c (FINI_ARRAYSZ)       8 (bytes)
 0x000000006ffffef5 (GNU_HASH)           0x400298
 0x0000000000000005 (STRTAB)             0x419588
 0x0000000000000006 (SYMTAB)             0x403a18
 0x000000000000000a (STRSZ)              187626 (bytes)
 0x000000000000000b (SYMENT)             24 (bytes)
 0x0000000000000015 (DEBUG)              0x0
 0x0000000000000003 (PLTGOT)             0x99c000
 0x0000000000000002 (PLTRELSZ)           34032 (bytes)
 0x0000000000000014 (PLTREL)             RELA
 0x0000000000000017 (JMPREL)             0x45ca38
 0x0000000000000007 (RELA)               0x449148
 0x0000000000000008 (RELASZ)             80112 (bytes)
 0x0000000000000009 (RELAENT)            24 (bytes)
 0x000000006ffffffe (VERNEED)            0x448f68
 0x000000006fffffff (VERNEEDNUM)         12
 0x000000006ffffff0 (VERSYM)             0x447272
