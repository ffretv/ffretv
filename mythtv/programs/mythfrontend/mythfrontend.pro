...
android {
    ...
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffrevutil.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffrepostproc.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)liffreavfilter.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffreswresample.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffreswscale.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffreavcodec.so
    ANDROID_EXTRA_LIBS += $$(MYTHINSTALLLIBCOMMON)libffreavformat.so
